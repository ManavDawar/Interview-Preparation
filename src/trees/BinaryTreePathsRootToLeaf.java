...
public class BinaryTreePathsRootToLeaf {
	...
	private static void binaryTreePathHelper(TreeNode root, String str, ArrayList<String> list) {
		if(root==null) {
			return;
		}
		...
		binaryTreePathHelper(root.left,str+root.val+ "->", list);
		binaryTreePathHelper(root.right, str+root.val+ "->", list);
	}
